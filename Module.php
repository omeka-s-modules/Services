...
CREATE TABLE services_transcription_project (id INT UNSIGNED AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, property_id INT DEFAULT NULL, preprocess_job_id INT DEFAULT NULL, transcribe_job_id INT DEFAULT NULL, save_job_id INT DEFAULT NULL, `label` VARCHAR(255) NOT NULL, model_id VARCHAR(255) NOT NULL, access_token VARCHAR(255) NOT NULL, query LONGTEXT DEFAULT NULL, target VARCHAR(255) DEFAULT NULL, created DATETIME NOT NULL, modified DATETIME DEFAULT NULL, INDEX IDX_346F4EE97E3C61F9 (owner_id), INDEX IDX_346F4EE9549213EC (property_id), INDEX IDX_346F4EE99493FB15 (preprocess_job_id), INDEX IDX_346F4EE96C79D14A (transcribe_job_id), INDEX IDX_346F4EE9466F8884 (save_job_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;
...
ALTER TABLE services_transcription_project ADD CONSTRAINT FK_346F4EE9549213EC FOREIGN KEY (property_id) REFERENCES property (id) ON DELETE SET NULL;
...
ALTER TABLE services_transcription_project ADD CONSTRAINT FK_346F4EE9466F8884 FOREIGN KEY (save_job_id) REFERENCES job (id) ON DELETE SET NULL;
