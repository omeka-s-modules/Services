...
CREATE TABLE services_transcription_image (id INT UNSIGNED AUTO_INCREMENT NOT NULL, item_id INT NOT NULL, media_id INT NOT NULL, storage_id VARCHAR(190) DEFAULT NULL, position INT DEFAULT NULL, created DATETIME NOT NULL, modified DATETIME DEFAULT NULL, INDEX IDX_F33D9830126F525E (item_id), INDEX IDX_F33D9830EA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;
...
ALTER TABLE services_transcription_image ADD CONSTRAINT FK_F33D9830126F525E FOREIGN KEY (item_id) REFERENCES item (id) ON DELETE CASCADE;
ALTER TABLE services_transcription_image ADD CONSTRAINT FK_F33D9830EA9FDD75 FOREIGN KEY (media_id) REFERENCES media (id) ON DELETE CASCADE;
SQL;
    ...
    public function uninstall(ServiceLocatorInterface $services)
    {
        ...
        $conn->exec('DROP TABLE IF EXISTS services_transcription_image;');
        $conn->exec('SET FOREIGN_KEY_CHECKS=1;');
    }
