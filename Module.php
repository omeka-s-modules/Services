...
class Module extends AbstractModule
{
    ...
    {
        $sql = <<<'SQL'
CREATE TABLE services_transcription_transcription (id INT UNSIGNED AUTO_INCREMENT NOT NULL, project_id INT UNSIGNED NOT NULL, page_id INT UNSIGNED NOT NULL, status SMALLINT DEFAULT NULL, job_id VARCHAR(255) DEFAULT NULL, text LONGTEXT DEFAULT NULL, data LONGTEXT DEFAULT NULL, created DATETIME NOT NULL, modified DATETIME DEFAULT NULL, INDEX IDX_3D5E0AFD166D1F9C (project_id), INDEX IDX_3D5E0AFDC4663E4 (page_id), UNIQUE INDEX UNIQ_3D5E0AFD166D1F9CC4663E4 (project_id, page_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;
CREATE TABLE services_transcription_project (id INT UNSIGNED AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, preprocess_job_id INT DEFAULT NULL, transcribe_job_id INT DEFAULT NULL, fetch_job_id INT DEFAULT NULL, `label` VARCHAR(255) NOT NULL, model_id VARCHAR(255) NOT NULL, access_token VARCHAR(255) NOT NULL, query LONGTEXT DEFAULT NULL, created DATETIME NOT NULL, modified DATETIME DEFAULT NULL, INDEX IDX_346F4EE97E3C61F9 (owner_id), INDEX IDX_346F4EE99493FB15 (preprocess_job_id), INDEX IDX_346F4EE96C79D14A (transcribe_job_id), INDEX IDX_346F4EE96BC46024 (fetch_job_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;
