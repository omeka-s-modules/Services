...
namespace DoctrineProxies\__CG__\Services\Entity;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ServicesTranscriptionProject extends \Services\Entity\ServicesTranscriptionProject implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'owner', 'label', 'query', 'created', 'modified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ServicesTranscriptionProject $proxy) {
