 ...
 */
class ServicesTranscriptionImage extends \Services\Transcription\Entity\ServicesTranscriptionImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ServicesTranscriptionImage $proxy) {
